...
object Test {
    ...
    def main(args: Array[String]) {
      val conf = new SparkConf().setAppName("NewMethod").setMaster("local").setJars(List("/home/liuh/workspace/class3/out/artifacts/class3_jar/class3.jar"))
      ...
      val matrix = sc.textFile("train01rmstruct.txt").flatMap(_.split("\t")).map(_.toInt)
      ...
      //happy.repartition(1).saveAsTextFile("hdfs://liuh-pc:9000/output/loop500000")
